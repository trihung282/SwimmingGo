...
public class BreastStyleVideo extends AppCompatActivity {

    //public  static String API_KEY = "AIzaSyA032cWNiBq9d0m5-mg0PZ63Z6asWKGHtY";
    String ID_FREEPLAYLIST = "PLo9kSKqKYi5EURgQi4r5j-VLg45MHCynD";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breast_style_video);
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(BreastStyleVideo.this, PlayVideo.class);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(BreastStyleVideo.this, "Lỗi", Toast.LENGTH_SHORT).show();
                    }
                }
        );
