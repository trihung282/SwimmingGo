...
public class SubWorkoutFragment extends Fragment {
    ...
    Exercise subExercise = CreateRecord.getInstance().getSubExercise();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_workout_sub, container, false);
        init();
        action();
        return view;
    }
...
//                subExercise.setRepetition(Integer.parseInt(edtReps.getText().toString()));
//                subExercise.setDistance(Integer.parseInt(txtDistance.getText().toString()));
//                subExercise.setStyle(spnStyle.getSelectedItem().toString());
//                subExercise.setDescription(edtDescription.getText().toString());
//                subExercise.setType("Khởi động");
//                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
//                transaction.replace(R.id.layout_workout, new RelaxedWorkoutFragment());
