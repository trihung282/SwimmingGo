...
public class FreeStyleVideo extends AppCompatActivity {

    //public  static String API_KEY = "AIzaSyA032cWNiBq9d0m5-mg0PZ63Z6asWKGHtY";
    String ID_FREEPLAYLIST = "PLo9kSKqKYi5E--MGr4wCupKX6cP2F3hhh";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_style_video);
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(FreeStyleVideo.this, PlayVideo.class);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FreeStyleVideo.this, "Lỗi", Toast.LENGTH_SHORT).show();
                    }
                }
        );
...
//
//        AndroidNetworking.get(urlGetJson)
//                .build()
...
//                            Toast.makeText(FreeStyleVideo.this, title, Toast.LENGTH_SHORT).show();
//                        } catch (JSONException e) {
//                            e.printStackTrace();
//                        }
//                    }
